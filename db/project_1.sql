...
INSERT INTO `projects` (`id`, `supervisor`, `group`, `status`, `title`) VALUES
(1, 'Matt Smith', 'group 1', 'supervisor', 'Game Graphics');
...
(0, 'Php Essentials', '1', 'http://amazon.co.uk'),
(1, 'Games Project', 'group2', 'itb.ie');
